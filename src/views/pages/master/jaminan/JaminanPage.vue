<template>
  <div class="pt-4">
    <n-space vertical>
      <n-card :class="`shadow`":title="`Tabel ${$route.name}`" :segmented="true" size="small">
  ...
  <n-modal v-model:show="modalDetail">
    <n-card :class="`shadow`"class="w-11/12  overflow-x-auto " title="Jaminan" :segmented="true" size="small">
