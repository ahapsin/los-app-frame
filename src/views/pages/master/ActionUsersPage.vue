    ...
    <n-card :class="`shadow-lg`" :segmented="{
        ...
        <n-form ref="formRef" :model="dynamicForm" :rules="rules" :label-placement="width <= 920 ? 'top' : 'left'"
            ...
            <n-form-item label="No KTP" path="no_ktp">
                <n-input-number placeholder="no KTP" v-model:value="dynamicForm.no_ktp" :show-button="false"
                    class="w-full" />
            </n-form-item>
            ...
            <n-form-item label="Cabang" path="cabang">
                <n-select :loading="loadingBranch" filterable placeholder="Pilih Cabang" label-field="nama"
                    value-field="id" :options="dataBranch" v-model:value="dynamicForm.cabang_id" />
            </n-form-item>
            <n-form-item label="Jabatan" path="jabatan">
                <n-select filterable :loading="loadingPosition" label-field="name" value-field="name"
                    placeholder="Pilih Jabatan" :options="dataPosition" v-model:value="dynamicForm.jabatan" />
            </n-form-item>
