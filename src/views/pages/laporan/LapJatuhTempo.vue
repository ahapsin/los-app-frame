<template>
    <div>
        <n-space vertical>
            <n-card :class="`shadow-lg`" :title="`Laporan Kredit Jatuh Tempo`" :segmented="true" size="small">
                ...
                <n-space vertical :size="12" class="pt-4">
                    <div class="flex flex-col md:flex-row gap-2 pt-4 pr-4 ps-4 bg-sc-50">
                        ...
                        <n-form-item label="Jatuh Tempo" class="w-full">
                            <n-select v-model:value="dynamicSearch.hari" multiple placeholder="Hari Jatuh Tempo"
                                clearable :options="creteOptFilter(-7, 7)" />
                        </n-form-item>
                    ...
                    <n-data-table :loading="loadTable" size="small" :columns="convertObjectToArray(showData)"
