<template>
    <div>
        <n-space vertical>
            <n-card :class="`shadow-lg`" :title="`Laporan`">
                <n-tabs type="card" animated @before-leave="handleBeforeLeave" @update:value="handleUpdateValue">
                    ...
                    <n-tab-pane name="listing_beban" tab="LISTING BEBAN">
                        <TabListBan :data="dataListBan" :columns="convertObjectToArray(dataListBan)"
                            :load="loadListingBeban" :page-size="10" @filter-form="handleRange" />
                    </n-tab-pane>
                ...
                <n-tabs type="line" :tabs-padding="20" pane-style="padding: 20px;"
                    ...
                    <n-tab-pane name="Pelanggan">
                        <n-scrollbar style="max-height: 500px" trigger="none">
                            ...
                            <n-form ref="formPelangganPekerjaan" :model="dataPekerjaan" :rules="rulesPekerjaan"
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <n-form-item label="Telepon Selullar 2" path="telepon_rumah" class="w-full">
                                        <n-input placeholder="Telepon Sellular 2"
                            ...
                            <n-form ref="formPelangganAlamatIdentitas" :model="alamatIdentitas" :rules="rulesIdentitas"
                                ...
                                <select-state-region v-model:provinsi="alamatIdentitas.provinsi"
                                    v-model:kota="alamatIdentitas.kota" v-model:kecamatan="alamatIdentitas.kecamatan"
                            ...
                            <n-form ref="formPelangganAlamatTagih" :model="alamatTagih" :rules="rulesAlamatTagih"
                                ...
                                <select-state-region v-model:provinsi="alamatTagih.provinsi"
                                    v-model:kota="alamatTagih.kota" v-model:kecamatan="alamatTagih.kecamatan"
                                    v-model:desa="alamatTagih.kelurahan" v-model:kodepos="alamatTagih.kode_pos" />
                    ...
                    <n-tab-pane name="Pinjaman">
                        <n-spin :show="spinPinjaman">
                            <div class="grid grid-rows-4 grid-flow-col gap-2 " v-if="dataDetailPinjaman">
                                <n-form-item :label="list.title" path="status" class="w-full"
                                    v-for="list in dataDetailPinjaman" :key="list.id">
                    ...
                    <n-tab-pane name="Jaminan">
                        <n-spin :show="spinJaminan">
                            <n-data-table :data="dataDetailJaminan" :columns="convertObjectToArray(dataDetailJaminan)"
                                sortable />
                        </n-spin>
                    </n-tab-pane>
