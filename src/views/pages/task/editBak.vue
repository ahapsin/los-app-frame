<template>
    ...
    <n-space vertical>
        ...
        <n-form ref="formRef" :model="model" :rules="rules" :label-placement="width <= 920 ? 'top' : 'top'"
            ...
            <n-card :class="`shadow-lg`" v-show="current == 1" title="Informasi Kredit" :segmented="{
                content: true,
                footer: 'soft',
            }">
            ...
            <n-card :class="`shadow-lg`" v-show="current == 2" title="Data Pelanggan" :segmented="{
                content: true,
                footer: 'soft',
            }">
                <n-space>
                    <n-form-item label="No KTP" path="no_ktp">
                        <n-input placeholder="NO KTP" v-model:value="pelanggan.no_ktp" :loading="loadingKTP"
                            @change="handleKtp" />
                    </n-form-item>
            ...
            <n-card :class="`shadow-lg`" v-show="current == 3" v-for="jaminan in jaminan" title="Data Jaminan"
                :segmented="{
                    content: true,
                    footer: 'soft',
                }" :key="jaminan.id">
                ...
                <n-space v-show="actionPage != 'view'">
                    ...
                    <file-upload title="STNK" endpoint="image_upload_prospect"
                        :def_value="findDocByType(dok_jaminan, 'stnk')" type="stnk" :idapp="pageData.id" />
                </n-space>
                ...
                <n-space v-show="actionPage != 'view'">
                    ...
                    <file-upload title="Kanan" endpoint="image_upload_prospect"
                        :def_value="findDocByType(dok_jaminan, 'kanan')" type="kanan" :idapp="pageData.id" />
                    <file-upload title="Kiri" :def_value="findDocByType(dok_jaminan, 'kiri')"
                        endpoint="image_upload_prospect" type="kiri" :idapp="pageData.id" />
                </n-space>
            </n-card>
            <n-card :class="`shadow-lg`" v-show="current == 4" title="Data Survey" :segmented="{
                content: true,
                footer: 'soft',
            }">
                ...
                <n-form-item label="Catatan Survey" path="cat_survey">
                    <n-input v-model:value="survey.catatan_survey" type="textarea" autosize
                ...
                <n-divider v-show="actionPage != 'view'" />
                <file-upload title="upload dokumen" endpoint="image_upload_prospect" type="other"
                    :idapp="pageData.id" />
            </n-card>
        </n-form>
