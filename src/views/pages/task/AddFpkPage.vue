        ...
        <n-form ref="formExtra" :model="calcCredit" :rules="rulesExtra"
          ...
          <div class="w-full flex md:flex-row flex-col gap-4">
            <div class="flex flex-col w-full">
              ...
              <n-form-item label="Plafond" path="Nama Bank" class="w-full">
                <n-input-number v-bind:dir="isRtl ? 'rtl' : 'ltr'"
                                v-model:value="ekstra.nilai_yang_diterima " :parse="parse" :show-button="false"
            ...
            <div class="flex flex-col w-full">
              <n-form-item label="Bunga " path="bunga" class="w-full">
                <div class="flex gap-2 w-full">
                  <n-input-number class="w-full" :show-button="false" v-model:value="ekstra.bunga" :min="0"
                                  :max="100">
                    <template #suffix>% /bulan</template>
                  </n-input-number>
                  <n-input class="w-full" pacleholder="tahunan" v-model:value="ekstra.bunga_tahunan" :min="1"
                           :max="100"
                           readonly>
              ...
              <n-form-item label="Angsuran " path="angsuran" class="w-full">
                <div class="flex gap-2 w-full">
                  <n-input-number :parse="parse" :format class="w-full" :show-button="false" v-model:value="ekstra.angsuran">
                  </n-input-number>
                </div>
              </n-form-item>
              <n-form-item label="Biaya Admin" path="biaya admin" class="w-full">
                <div class="flex gap-2 w-full">
                  <n-input-number v-model:value="ekstra.biaya_admin" type="text" class="w-full"
                                  :parse="parse" :format="format" :show-button="false">
                    <template #suffix> %</template>
                  </n-input-number>
                  <n-input-number v-model:value="ekstra.total_admin" type="text" class="w-full" disabled
                                  :parse="parse" :format="format" :show-button="false">
                  </n-input-number>
                </div>
              </n-form-item>
              <n-form-item label="Nilai yang diterima" path="nilai_yang_diterima">
                <n-input-number :parse="parse" :format="format" :placeholder="calcCredit.pokok_pembayaran"
                                :show-button="false" class="flex !w-full" @update:value="handlePlafond"
                                :loading="loading" v-model:value="ekstra.nilai_yang_diterima"/>
