    ...
    <div class="relative">
        ...
        <div class="flex  gap-2 flex-col p-2 px-4 bg-white">
            ...
            <n-tabs type="segment" animated @before-leave="handleBeforeLeave">
                ...
                <n-tab name="waiting" tab="Semua Order">Menunggu</n-tab>
            </n-tabs>
        </div>
        <div class="p-2 flex flex-col gap-2">
            ...
            <div class="overflow-clip flex flex-col gap-4 bg-white rounded-lg border" v-else v-for="data in showData"
                ...
                <div class="flex justify-between px-4">
                    ...
                    <div class="font-bold">
                        <n-tag :type="statusTag(data.status_code)" size="small" round>{{ data.status }}
                        </n-tag>
                    </div>
                </div>
                <div class="bg-sf flex gap-2 p-2">
                    ...
                    <n-button size="small" type="info" v-if="data.status_code === 'CROR'"
                        @click="handleEdit(data)">Ubah</n-button>
