<template>
    ...
    <n-space vertical class="">
        <n-form ref="formRef" :model="pelanggan" :rules="rules" :label-placement="width <= 920 ? 'top' : 'top'"
            ...
            <n-card :class="`shadow-lg`" v-show="current == 2" title="Data Pelanggan" :segmented="{
                ...
                <div class="md:flex gap-2">
                    <n-form-item label="No KTP" path="no_ktp" class="w-full">
                        <n-input :show-button="false" placeholder="NO KTP" v-model:value="pelanggan.no_ktp"
                            :loading="loadingKTP" @change="handleKtp" class="w-full" maxlength="16" clearable />
                    </n-form-item>
            ...
            <n-card :class="`shadow-lg`" v-show="current == 3" class="flex" title="Data Jaminan" :segmented="{
                content: true,
                footer: 'soft',
            }">
                <div v-show="jaminan.nilai != '' && order.plafond > jaminan.nilai * 0.5" class="pb-4">
            ...
            <n-card :class="`shadow-lg`" v-show="current == 4" title="Data Survey" :segmented="{
                ...
                <n-form-item label="Catatan Survey" path="cat_survey">
                    <n-input v-model:value="survey.catatan_survey" @input="upCase" type="textarea"
