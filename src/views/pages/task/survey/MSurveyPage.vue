<template>
  <div class="relative">
    ...
    <div class="p-2 flex flex-col gap-2">
      ...
      <div class="overflow-clip flex flex-col gap-4 bg-white rounded-lg border" v-else v-for="data in showData" :key="data.id" :title="data.nama_debitur">
        ...
        <div class="flex justify-between px-4">
          ...
          <div class="font-bold"><n-tag :type="statusTag(data.status_code)" size="small" round>{{data.status}}</n-tag></div>
        </div>
        <div class="bg-sf flex gap-2 p-2">
          ...
          <n-button type="error" @click="handleConfirm(data)" v-if="data.status_code === 'DRSVY'">Hapus</n-button>
        </div>
      </div>
    </div>
  </div>
