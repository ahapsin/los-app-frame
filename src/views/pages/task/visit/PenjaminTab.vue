<template>
    <n-scrollbar style="max-height: 400px">
        <n-form ref="formPelanggan" :model="pelanggan" :rules="rulesPelanggan" require-mark-placement="right-hanging">
            <n-collapse>
                <n-collapse-item title="DATA PENJAMIN">
                    ...
                    <div class="flex gap-2">
                        ...
                        <n-form-item label="Hubungan dengan debitur " path="status_pemohon" class="w-full">
                            <n-input placeholder="Hubungan dengan debitur"
                                v-model:value="pelanggan.hub_debitur" maxlength="13" />
                        </n-form-item>
                    </div>
                </n-collapse-item>
                <n-collapse-item title="DATA REFERENSI / KONTAK DARURAT">
                    <div class="md:flex gap-2">
