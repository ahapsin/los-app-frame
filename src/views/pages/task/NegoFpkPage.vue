        ...
        <n-tabs type="line" animated>
            <n-tab-pane name="pelanggan" tab="Pelanggan">
                <div class="flex w-full gap-2">
                    <n-form-item label="Nama" path="nama" class="w-full">
                        <n-input placeholder="nama" v-model:value="dataPelanggan.nama" readonly />
                    </n-form-item>
                    <n-form-item label="Nama Panggilan" path="nama_panggilan" class="w-full">
                        <n-input placeholder="nama panggilan" v-model:value="dataPelanggan.nama_panggilan" readonly />
                    </n-form-item>
                </div>
                <div class="flex w-full gap-2">
                ...
                <n-form-item label="Status Kawin" path="jenis_kelamin">
                    <n-input-group>
                        <n-select disabled placeholder="Status Kawin" :options="optStatusKawin"
                            v-model:value="dataPelanggan.status_kawin" readonly />
                    </n-input-group>
                </n-form-item>
                <div class="flex w-full gap-2">
                    <n-form-item label="Identitas" path="plafond" class="w-full">
                        <n-select disabled placeholder="Jenis Identitas" :options="optJenisIdentitas"
                ...
                <n-space>
                    ...
                    <n-upload :data="{ type: 'nego' }" list-type="image-card" :custom-request="handleImagePost">
                    </n-upload>
                </n-space>
                ...
                <div class="flex gap-2">
                    ...
                    <n-form-item label="Pekerjaan ID" path="nama" class="w-full">
                        <n-input placeholder="Pekerjaan ID" v-model:value="dataPekerjaan.pekerjaan_id" readonly>
                        </n-input>
                    </n-form-item>
                </div>
            ...
            <n-tab-pane name="order" tab="Order">
                <div class="flex gap-2">
                    ...
                    <n-form-item label="Tipe Order" path="order" class="w-full">
                        <n-select disabled placeholder="tipe" :options="optTipeOrder"
                            v-model:value="dataOrder.order_tipe" readonly />
                    </n-form-item>
                </div>
                <n-form-item label="Unit Bisnis" path="unit_bisnis">
                    <n-input placeholder="Unit bisnis" v-model:value="dataOrder.unit_bisnis" readonly />
                </n-form-item>
                ...
                <n-form-item label="Cara Bayar" path="cara_bayar">
                    <n-input placeholder="Cara Bayar" v-model:value="dataOrder.cara_bayar" readonly />
                </n-form-item>
                <n-divider readonly />
                <n-form-item label="Nama Ibu Kandung" path="nama_ibu_kandung">
                    <n-input placeholder="Nama Ibu Kandung" v-model:value="dataOrder.nama_ibu" readonly />
                </n-form-item>
                <n-form-item label="Kategori" path="kategori">
                    <n-select disabled placeholder="agama" :options="optKategori" v-model:value="dataOrder.kategori"
                        readonly />
                </n-form-item>
                <n-form-item label="Lama Bekerja" path="lama_kerja">
                    <n-input placeholder="lama bekerja" v-model:value="dataOrder.lama_bekerja" readonly />
                </n-form-item>
                <n-form-item label="Tanggungan" path="tanggungan">
                    <n-input placeholder="Jumlah Tanggungan" v-model:value="dataOrder.tanggungan" readonly />
                </n-form-item>
                <div class="flex gap-2">
                    <n-form-item label="Pendapatan Pelanggan" path="pendapatan_pribadi" class="w-full">
                        <n-input-number :parse="parse" :format="format" v-model:value="dataOrder.pendapatan_pribadi"
                            :show-button="false" class="flex !w-full" placeholder="Pribadi" readonly />
                    </n-form-item>
                    <n-form-item label="Pendapatan Pasangan" path="pendapatan_pasangan" class="w-full">
                        <n-input-number :parse="parse" :format="format" v-model:value="dataOrder.pendapatan_pasangan"
                            :show-button="false" class="flex !w-full" placeholder="Pasangan" readonly />
                    </n-form-item>
                    <n-form-item label="Pendapatan Lainnya" path="pendapatan_lainnya" class="w-full">
                        <n-input-number :parse="parse" :format="format" v-model:value="dataOrder.pendapatan_lainnya"
                            :show-button="false" class="flex !w-full" placeholder="Lainnya" readonly />
                    </n-form-item>
                </div>
                <n-form-item label="Biaya" path="biaya">
                    <n-input-number :parse="parse" :format="format" v-model:value="dataOrder.biaya_bulanan"
                        :show-button="false" class="flex !w-full" placeholder="Pengeluaran" readonly />
                </n-form-item>
                <n-divider title-placement="left"> NPWP </n-divider>
                <n-form-item label="No NPWP" path="no_npwp">
                    <n-input placeholder="No NPWP" v-model:value="dataOrder.no_npwp" readonly />
                </n-form-item>
            ...
            <n-tab-pane name="tambahan" tab="Tambahan">
                <n-form-item label="Nama BI" path="nama_bi">
                    <n-input placeholder="Nama BI" v-model:value="dataTambahan.nama_bi" readonly />
                </n-form-item>
                <n-form-item label="Email" path="email">
                    <n-input placeholder="Email" v-model:value="dataTambahan.email" readonly />
                </n-form-item>
                <n-form-item label="Info Khusus" path="info_khusus">
                    <n-input placeholder="Info Khusus" v-model:value="dataTambahan.info_khusus" readonly />
                </n-form-item>
                <n-form-item label="Usaha Lain 1" path="usaha_lain1">
                    <n-input placeholder="Usaha Lain 1" v-model:value="dataTambahan.usaha_lain1" readonly />
                </n-form-item>
                <n-form-item label="Usaha Lain 2" path="usaha_lain2">
                    <n-input placeholder="Usaha Lain 2" v-model:value="dataTambahan.usaha_lain2" readonly />
                </n-form-item>
                <n-form-item label="Usaha Lain 3" path="usaha_lain3">
                    <n-input placeholder="Usaha Lain 3" v-model:value="dataTambahan.usaha_lain3" readonly />
                </n-form-item>
                <n-form-item label="Usaha Lain 4" path="usaha_lain1">
                    <n-input placeholder="Usaha Lain 4" v-model:value="dataTambahan.usaha_lain4" readonly />
                </n-form-item>
                <n-divider title-placement="left">
                    Kerabat dalam kondisi darurat
                </n-divider>
                <n-form-item label="Nama Kerabat" path="nama_kerabat">
                    <n-input placeholder="Nama Kerbat" v-model:value="dataKerabat.nama" readonly />
                </n-form-item>
                <n-form-item label="Alamat" path="alamat">
                    <div class="flex gap-2">
                        <n-form-item label="Alamat" class="w-full">
                            <n-input placeholder="Alamat" v-model:value="dataKerabat.alamat" readonly />
                        </n-form-item>
                        <n-form-item label="RT">
                            <n-input placeholder="RT" v-model:value="alamatIdentitas.rt" readonly>
                            </n-input>
                ...
                <select-state-region v-model:provinsi="dataKerabat.provinsi" v-model:kota="dataKerabat.kota"
                    v-model:kecamatan="dataKerabat.kecamatan" v-model:desa="dataKerabat.kelurahan" readonly />
                <n-form-item label="Kode Pos" path="kodepos">
                    <n-input placeholder="Kode Pos" v-model:value="dataKerabat.kode_pos" readonly />
                </n-form-item>
                <n-form-item label="Telepon" path="telepon">
                    <div class="flex gap-2">
                        <n-form-item label="Telepon Rumah" class="w-full">
                            <n-input placeholder="Telepon Rumah" v-model:value="dataKerabat.no_telp" readonly />
                        </n-form-item>
                        <n-form-item label="Telepon Selular" class="w-full">
                            <n-input placeholder="Telepon Selular" v-model:value="dataKerabat.no_hp" readonly />
                        </n-form-item>
                    </div>
                </n-form-item>
                ...
                <n-form-item label="Alamat">
                    <div class="flex gap-2">
                        <n-form-item label="Alamat" class="w-full">
                            <n-input placeholder="Alamat" v-model:value="dataSurat.alamat" readonly />
                        </n-form-item>
                        <n-form-item label="RT">
                ...
                <select-state-region v-model:provinsi="dataSurat.provinsi" v-model:kota="dataSurat.kota"
                    v-model:kecamatan="dataSurat.kecamatan" v-model:desa="dataSurat.kelurahan" readonly />
                <n-form-item label="Kode Pos" path="desa">
                    <n-input placeholder="Kode Pos" v-model:value="dataSurat.kode_pos" readonly />
                </n-form-item>
                ...
                <n-dynamic-input v-model:value="formAssign.info_bank" :on-create="onCreate">
                    ...
                    <template #default="{ value }">
                        <div class="flex flex-col md:flex-row w-full gap-2 bg-pr-50 p-2 pb-0 rounded-md">
                            ...
                            <n-form-item label="No Rekening" path="norkening" class="w-full">
                                <n-input v-model:value="value.no_rekening" type="text" readonly />
                            </n-form-item>
                ...
                <div class="w-full flex md:flex-row flex-col gap-4">
                    <div class="flex flex-col w-full">
                        ...
                        <n-form-item label="Periode" path="periode">
                            <n-space>
                                <n-input v-model:value="calcCredit.periode" placeholder="periode" disabled />
                        ...
                        <n-form-item label="Biaya Transfer" path="biaya_transfer">
                            <n-input-number :parse="parse" :format="format" v-model:value="calcCredit.biaya_transfer"
                                placeholder="Biaya Transfer" :show-button="false" class="flex !w-full" disabled />
                        </n-form-item>
            ...
            <template #suffix>
                <n-button :loading="loading" type="primary" @click="handleSave">Simpan</n-button>
            </template>
        </n-tabs>
    </n-card>
</template>
