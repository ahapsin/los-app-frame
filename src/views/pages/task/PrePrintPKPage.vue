        ...
        <CollateralCheck :coll_data="payloadCheck()" @coll_val="handleCollCheck"/>
            ...
            <div class="w-full" v-if="pkData.order_validation?.length != 0">
                <n-alert :title="`${pkData.order_validation?.length} Catatan`" type="warning" class="shadow">
                    <div class="text-red-500" v-for="(messageValidation, i) in pkData.order_validation"
                    ...
                    <n-watermark :content="apptitle" cross selectable :font-size="16" :line-height="16" :width="192"
                        ...
                        <div class="bg-white max-w-[900px]  p-8" v-show="optPrint.pkPage">
                            ...
                            <table border="1" class="mb-10">
                                ...
                                <tr>
                                    <td>
                                        Pihak Kedua menyatakan dengan benar bahwa Perjanjian Pemberian Pinjaman ini
                                        adalah untuk keperluan pribadi <b>Bukan Untuk Atas Nama Orang Lain</b>, dan
                                        Pihak Kedua bertanggung jawab penuh atas segala pinjaman dan seluruh pembayaran
                                        angsuran sesuai yang sudah disepakati dalam perjanjian ini
                                    </td>
                                </tr>
                                <tr>
                                    <td>
...
<script setup>
import { CancelFilled as CancelIcon, EditOutlined as EditIcon, LocalPrintshopRound as PrintIcon } from "@vicons/material";
