      ...
      <n-space>
        ...
        <div>
            <n-data-table striped size="small" :row-key="(row) => row.loan_number" :columns="columns"
                :data="dataPayment" class="pb-2" :pagination="pagination" :loading="loadDataPayment" />
        </div>
    </n-card>
    <n-modal v-model:show="showModal">
        <n-card :class="`shadow-lg`" title="Konfirmasi perubahan data jaminan" class="w-1/2" :segmented="true"
            size="small">
            <template #header-extra>
                <n-space>
            ...
            <div class="grid grid-cols-3 gap-4 p-2">
                ...
                <div class="flex flex-col">
                    ...
                    <n-text strong class="text-md border-b"> {{ bodyModal.keterangan ? bodyModal.keterangan : 'N/A'
                        }}</n-text>
                </div>
            </div>
