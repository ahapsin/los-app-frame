<template>
    <n-space class="mb-4 bg-white p-2 rounded-lg items-center">
        ...
        <n-button @click="currentComponent = 'BukaRekening'" quaternary :type="currentComponent === 'BukaRekening'? 'primary':'default'">
        ...
        <n-button type="primary" secondary @click="currentComponent = 'SetorTarik'">
