<template>
    <n-card :class="`shadow-lg`" :segmented="{
        ...
        <template #header>Tambah Pelunasan Remidial</template>
  ...
  >
        ...
        <div>
            <n-form-item label="Cabang Pelunasan">
    ...
    :on-update:checked-row-keys="handleFasilitas" :loading="loadSearch" class="pb-2" v-show="dataFasilitas" /> -->
        ...
        <n-spin v-if="displayDetail" :show="spinnerShow">
            ...
            <div>
                ...
                <n-alert title="info" type="warning"
...
const handleBack = () => {
    router.push({ name: "pelunasan remidial" });
};
