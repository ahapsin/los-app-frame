<template>
    <n-card :class="`shadow-lg`" content-style="padding: 0;" size="small" bordered>
        <template #header>PEMBAYARAN
        </template>
        <template #header-extra>
            <n-space>
                <n-button v-if="width > 480" strong secondary @click="handleAddPay">
                    <template #icon>
                        <n-icon>
                            <add-icon />
                        </n-icon>
...
import { DotsVertical as detailIcon } from "@vicons/tabler";
