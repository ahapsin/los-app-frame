                    ...
                    <n-form-item-gi path="nestedValue.path2">
                        <n-auto-complete v-model:value="valOptSearch" :options="listCustomer"
                            ...
                            <template #default="{
                                ...
                                <n-input clearable @clear="handleCloseNasabah" :value="valOptSearch"
                                    placeholder="Pelanggan" @input="handleInput" @focus="handleFocus"
                                    @blur="handleBlur">
                                    <template #prefix>
                ...
                <n-card :class="`shadow-lg`" title="Data Jaminan" :bordered="false" embedded size="small">
                    <n-grid :cols="1">
                        <n-gi>
                            ...
                            <div class="flex">
                                <label class="w-1/3">BPKB No </label><span> <n-text strong>##no bpkb##</n-text></span>
                            </div>
                            <div class="flex">
                                <label class="w-1/3">BPKB atas nama</label><span> <n-text strong>##atasnama
                                        bpkb##</n-text></span>
                            </div>
                            <div class="flex">
                            ...
                            <div class="flex">
                                <label class="w-1/3">Warna/No.Polisi</label><span> <n-text strong>HITAM/E 123
                                        yy</n-text></span>
                            </div>
                            <div class="flex">
                                <label class="w-1/3">No. Rangka/Mesin</label><span> <n-text
                                        strong>norangka/nomesin</n-text></span>
                            </div>
                        </n-gi>
                    </n-grid>
                </n-card>
